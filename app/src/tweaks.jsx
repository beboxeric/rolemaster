...
// TweaksPanel is no longer mounted anywhere in the app — the floating ⚙
// settings wheel was removed by product decision. Component kept as a
// no-op so legacy imports don't break the build.
